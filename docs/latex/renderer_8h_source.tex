...
\DoxyCodeLine{00068\ }
\DoxyCodeLine{00075\ \ \ \ \ SDL\_Texture*\ \mbox{\hyperlink{class_renderer_a3d386b12348c2d9e9de33765bc034e87}{createTexture}}(CreateTextureKey\ key,\ SDL\_Surface*\ surface)\ \textcolor{keyword}{const};}
\DoxyCodeLine{00076\ }
\DoxyCodeLine{00081\ \ \ \ \ \textcolor{comment}{//SDL\_Renderer*\ getRenderer(void)\ noexcept;}}
\DoxyCodeLine{00082\ }
\DoxyCodeLine{00088\ \ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{class_renderer_ab965431b93fb4daf2fa2af00b328856a}{registerObject}}(std::shared\_ptr<RenderObjectBase>\ objectPtr)\ \textcolor{keyword}{noexcept};}
\DoxyCodeLine{00089\ }
\DoxyCodeLine{00095\ \ \ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{class_renderer_a32457b0b18154de7a9ad361009a987c2}{removeObject}}(std::weak\_ptr<RenderObjectBase>\ objectPtr)\ \textcolor{keyword}{noexcept};}
\DoxyCodeLine{00096\ }
\DoxyCodeLine{00102\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_renderer_a7d79b5b497ea019acf577ed7b77d3247}{render}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{class_renderer_1_1_render_key}{RenderKey}}\&\ key);}
\DoxyCodeLine{00103\ \ \ \ \ }
\DoxyCodeLine{00109\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_renderer_a30d63627ebb7bb28e455cdbb5a9aa4cf}{moveLayerUp}}(std::shared\_ptr<RenderObjectBase>\ objectPtr);}
\DoxyCodeLine{00110\ }
\DoxyCodeLine{00116\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_renderer_acdcbdbc2de3e4ee79e9ddcbb20269139}{moveLayerDown}}(std::shared\_ptr<RenderObjectBase>\ objectPtr);}
\DoxyCodeLine{00117\ }
\DoxyCodeLine{00123\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_renderer_a33bea341dec4876252bd11c461d4e0b2}{moveLayerTop}}(std::shared\_ptr<RenderObjectBase>\ objectPtr);}
\DoxyCodeLine{00124\ }
\DoxyCodeLine{00130\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_renderer_a79f800b2a66fad3a0941c417700c2aed}{moveLayerBottom}}(std::shared\_ptr<RenderObjectBase>\ objectPtr);}
\DoxyCodeLine{00131\ }
\DoxyCodeLine{00135\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_renderer_a80dbe663620281582a04e1707da26c16}{clear}}()\ noexcept;}
\DoxyCodeLine{00136\ \ \ \ \ }
\DoxyCodeLine{00140\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_renderer_a06e99214736750f87bc1ffc375e0fc8a}{debug}}(\textcolor{keywordtype}{void})\ const\ noexcept;}
\DoxyCodeLine{00141\ \};}
